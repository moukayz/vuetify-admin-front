...
function texts(color) {
  ...
  ctx.fillText("PCG", innerWidth / 2, innerHeight / 2 - 5);

  ctx.fillStyle = "white";
  ctx.shadowBlur = 30;
  ctx.shadowColor = color;
  ctx.fillText("PCG", innerWidth / 2, innerHeight / 2);
  ...
  ctx.fillStyle = "#fff";
  ctx.setTransform(1, -0.15, 0, 1, 0, -10);
  ctx.fillText("Security", innerWidth / 2, innerHeight / 2 + innerHeight / 10);
